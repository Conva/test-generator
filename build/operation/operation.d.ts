...
export declare type CodeOperation<DatabaseType extends string, ResponseType extends {}> = DatabaseOperation<DatabaseType> | ControllerOperation<ResponseType> | CommentOperation | TestingEnvironmentOperation;
